...
"[project]/app/api/stats/overview/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const [total, active, byPlatform, volume, lastSync] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.count(),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.count({
                where: {
                    active: true
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.groupBy({
                by: [
                    'platform'
                ],
                _count: true
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.aggregate({
                _sum: {
                    volume24h: true
                }
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.findFirst({
                orderBy: {
                    lastSyncedAt: 'desc'
                },
                select: {
        ...
        const polymarketCount = byPlatform.find((p)=>p.platform === 'POLYMARKET')?._count ?? 0;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__266602db._.js.map
...
"[project]/app/api/pins/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const pins = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pin.findMany({
        where: {
...
async function POST(req) {
    ...
    if (!type || !targetId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'type and targetId required'
        }, {
            status: 400
        });
    }
    const pin = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pin.upsert({
        where: {
...
async function DELETE(req) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pin.deleteMany({
        where: {
            userId: session.user.id,
            type,
            targetId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9808bf23._.js.map
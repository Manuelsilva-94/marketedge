...
"[project]/app/api/admin/match-backlog/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    const totalKalshiActive = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.count({
        where: {
            platform: 'KALSHI',
            active: true
        }
    });
    const withMatch = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.count({
        where: {
            platform: 'KALSHI',
            active: true,
            OR: [
    ...
    const byCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$queryRaw`
...
async function POST(req) {
    ...
    for (const kalshiMarket of kalshiMarkets){
        try {
            ...
            const candidates = matcher.findMatchesFromCandidates(kalshiMarket, polyMarkets, MIN_KEYWORD_SCORE);
            if (candidates.length === 0) {
    ...
    const remaining = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.count({
        where: {
            platform: 'KALSHI',
            active: true,
            AND: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cbf5c5fa._.js.map
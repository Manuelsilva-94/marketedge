...
async function GET() {
    ...
    const pinnedArbitrage = arbitragePins.length > 0 ? await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].arbitrageOpportunity.findMany({
        where: {
            matchId: {
                in: arbitragePins.map((p)=>p.targetId)
            },
            active: true
        },
        include: {
    ...
    const pinnedComparisons = await Promise.all(comparisonPins.map(async (pin)=>{
        const [marketAId, marketBId] = pin.targetId.split(':');
        if (!marketAId || !marketBId) return null;
        const [marketA, marketB] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.findUnique({
                where: {
                    id: marketAId
                },
                select: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c5820a5._.js.map
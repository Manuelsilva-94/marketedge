...
"[project]/app/api/cron/sync-active-markets/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        for(let i = 0; i < markets.length; i += BATCH_SIZE){
            ...
            await Promise.allSettled(batch.map(async (market)=>{
                try {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].market.update({
                        where: {
                            id: market.id
                        },
                        data: {
        ...
        console.log(`[SyncMarkets] Done: ${updated} updated, ${markedInactive} inactive, ${errors} errors in ${duration}ms`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1834215f._.js.map